            ...
            <div className="gap-8 flex flex-col items-start col-span-5 col-start-1 w-full font-vogue text-[24px]">
              ...
              <div className="flex flex-col gap-4 text-center w-full text-primary text-[14px] pb-[83px]">
                <div className="grid grid-cols-5 w-full gap-5 uppercase">
                  <button className="col-span-1  p-[10px] button-gradient btn-chocolat">chocolat</button>
                  <button className="col-span-1 col-start-4 p-[10px] button-gradient btn-carrot">CARROT</button>
                </div>
                <div className="grid grid-cols-5 w-full gap-5 uppercase">
                  <button className="col-span-1 p-[10px] button-gradient btn-pistache">PISTACHE</button>
                  <button className="col-span-1 p-[10px] button-gradient btn-citron col-start-4">CITRON</button>
                </div>
                <div className="grid grid-cols-5 w-full gap-5 uppercase">
                  <button className="col-span-1 p-[10px] button-gradient btn-caramel">CARAMEL</button>
                  <button className="col-span-1 p-[10px] button-gradient btn-marbre col-start-4">MARBRÉ</button>
                </div>
              </div>
            </div>
          </div>
